...
# Email and SMS services are disabled/removed for this project
...
# Email/SMS notifications disabled: no service initialization
...
async def download_guest_badge(request: Request, guest: Dict = Depends(get_current_guest)):
    ...
    return StreamingResponse(
        ...
        headers={
            "Content-Disposition": f'attachment; filename="{config.get("CONFERENCE","QRPrefix")}_MyBadge_{guest["ID"]}.png"'
        }
    )
...
async def register_guest(
    ...
    try:
        ...
        # SMS notifications disabled in this project

        # Email notifications disabled in this project
