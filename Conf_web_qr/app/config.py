...
class Config:
    ...
    def _set_defaults(self):
        ...
        # Conference defaults for easy portability
        self.config['CONFERENCE'] = {
            'Name': 'Magna Endocrine Update 2025',
            'Tagline': 'Healthcare and Education Foundation',
            'Dates': 'September 20-21, 2025',
            'Venue': 'The Chancery Pavilion',
            'City': 'Bangalore',
            'Website': 'https://www.magnacode.org',
            'ContactEmail': 'info@magnacode.org',
            'SupportPhone1': '+91 63698 55704',
            'SupportPhone2': '+91 96066 09785',
            'QRPrefix': 'MAGNACODE2025',
            'ScheduleFile': 'MAGNACODE2025_Schedule.pdf'
        }
