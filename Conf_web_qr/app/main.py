...
templates.env.globals["app_version"] = config.get('DEFAULT', 'SoftwareVersion')
    ...
    try:
        ...
        return templates.TemplateResponse(
            "index.html",
            {
                "request": request,
                "now": datetime.now(),
                "conference_name": config.get('CONFERENCE', 'Name'),
                "conference_tagline": config.get('CONFERENCE', 'Tagline'),
                "conference_dates": config.get('CONFERENCE', 'Dates'),
                "conference_venue": config.get('CONFERENCE', 'Venue'),
                "conference_city": config.get('CONFERENCE', 'City')
            }
        )
    except Exception as e:
